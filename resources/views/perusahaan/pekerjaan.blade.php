...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ URL('/perusahaan/pekerjaan') }}">Pekerjaan</a></li>
    </ol>
...
<div class="page-content">
    <!-- Panel Basic -->
    @if ($message = Session::get('pekerjaan_user_action'))
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href="{{ URL('perusahaan/pekerjaan/delete/'.$row->id) }}"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php $seq_number++; ?>
                    @endforeach
...
<div class="modal fade modal-primary" id="exampleModalPrimary" aria-hidden="true" aria-labelledby="exampleModalPrimary" role="dialog" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ URL('perusahaan/pekerjaan_store') }}" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade modal-info" id="exampleModalInfo" aria-hidden="true" aria-labelledby="exampleModalInfo" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ URL('perusahaan/pekerjaan/update') }}" enctype="multipart/form-data">
                @csrf
...
<script type="text/javascript">
    function data_detail(id) {
        $.ajax({
            type: "GET",
            url: "{{ URL('perusahaan/pekerjaan/detail') }}" + "/" + id,
            cache: false,
            dataType: "json",
    ...
    function data_edit(id) {
        $.ajax({
            type: "GET",
            url: "{{ URL('perusahaan/pekerjaan/edit') }}" + "/" + id,
            cache: false,
            dataType: "json",
            success: function(msg) {
                $("#id_edit").val(msg['id_edit']);
                $("#judul_lowongan_edit").val(msg['judul_lowongan_edit']);
                //$("#deskripsi_lowongan_edit").val(msg['deskripsi_lowongan_edit']);
