...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ URL('/perusahaan/pelamar') }}">Pelamar</a></li>
    </ol>
...
<div class="page-content">
    <!-- Panel Basic -->
    @if ($message = Session::get('pelamar_perusahaan_action'))
            ...
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-success" role="button" onclick="data_detail(<?= $row->pelamar_id; ?>)" data-target="#exampleModalSuccess" data-toggle="modal"><i class="fa fa-info" title="Detail Data"></i></button>
                            <a class="btn btn-danger" href="{{ URL('perusahaan/pelamar/delete/'.$row->pelamar_id) }}"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php $seq_number++; ?>
                    @endforeach
...
<script type="text/javascript">
    function data_detail(id) {
        $.ajax({
            type: "GET",
            url: "{{ URL('perusahaan/pelamar/detail') }}" + "/" + id,
            cache: false,
            dataType: "json",
