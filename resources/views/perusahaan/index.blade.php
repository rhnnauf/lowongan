...
<body class="animsition">
                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" role="menuitem" href="{{ URL('perusahaan/logout') }}">
    ...
    <div class="site-menubar">
            ...
            <div>
                <div>
                    <ul class="site-menu" data-plugin="menu">
                        ...
                        <li class="site-menu-item <?= (Session::get('menu_perusahaan') == "dashboard") ? 'active' : ''; ?>">
                            <a class="animsition-link" href="{{ URL('perusahaan/dashboard') }}">
                                <i class="site-menu-icon md-view-dashboard" aria-hidden="true"></i>
                                <span class="site-menu-title">Dashboard</span>
                            </a>
                        </li>
                        <li class="site-menu-item <?= (Session::get('menu_perusahaan') == "perusahaan") ? 'active' : ''; ?>">
                            <a class="animsition-link" href="{{ URL('perusahaan/data-perusahaan') }}">
                                <i class="site-menu-icon fa-building" aria-hidden="true"></i>
                                <span class="site-menu-title">Perusahaan</span>
                            </a>
                        </li>
                        <li class="site-menu-item <?= (Session::get('menu_perusahaan') == "pekerjaan") ? 'active' : ''; ?>">
                            <a class="animsition-link" href="{{ URL('perusahaan/pekerjaan') }}">
                                <i class="site-menu-icon fa-newspaper-o" aria-hidden="true"></i>
                                <span class="site-menu-title">Pekerjaan</span>
                            </a>
                        </li>
                        <li class="site-menu-item <?= (Session::get('menu_perusahaan') == "pelamar") ? 'active' : ''; ?>">
                            <a class="animsition-link" href="{{ URL('perusahaan/pelamar') }}">
        ...
        <div class="site-menubar-footer">
            <a href="{{ URL('perusahaan/pekerjaan') }}" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Pekerjaan">
                <span class="icon fa-newspaper-o" aria-hidden="true"></span>
            </a>
            <a href="{{ URL('perusahaan/pelamar') }}" data-placement="top" data-toggle="tooltip" data-original-title="Pelamar">
                <span class="icon fa-universal-access" aria-hidden="true"></span>
            </a>
            <a href="{{ URL('perusahaan/logout') }}" data-placement="top" data-toggle="tooltip" data-original-title="Logout">
